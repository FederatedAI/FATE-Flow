...
Import needed fate_components for building a hetero secureboost model:
...
```python
    ...
    from pipeline.component import Reader, DataIO, Intersection, HeteroSecureBoost # fate fate_components
    ...
    # find sample intersection using Intersection fate_components
    intersect_0 = Intersection(name="intersection_0")
    # hetero secureboost fate_components, setting algorithm parameters
    ...
    # add fate_components to pipeline, in the order of task execution
...
fate fate_components in the training step. We load training pipeline from 'pipeline_saved.pkl'.
...
```python
    ...
    # deploy fate_components in training step
    ...
    # add selected fate_components from train pipeline onto predict pipeline
